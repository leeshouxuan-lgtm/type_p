...
const Content = (() => {
    ...
    const defaults = {
        ...
        keyboard_basic_ko: {
            items: [
                'ㅁㄴㅇㄹ', 'ㅓㅏㅣ;', 'ㅁㄴㅇㄹ ㅓㅏㅣ;',
                'ㅁㅓㄴㅏㅇㅣㄹㅣ', 'ㄹㅏㅇㅣㄴㅓㅁㅓ', 'ㅇㅏㄴㅣㅇㅓㄹㅣ',
                'ㅂㅈㄷㄱㅅ', 'ㅛㅕㅑㅐㅔ', 'ㅂㅈㄷㄱㅅ ㅛㅕㅑㅐㅔ',
                'ㄱㅏㅅㅓㄱㅗㅛㅕ', 'ㅂㅐㄷㅔㅅㅣㄱㅏ', 'ㅅㅜㅅㅏㄱㅗㄱㅣ',
                'ㅋㅌㅊㅍㅎ', 'ㅠㅜㅡ', 'ㅋㅌㅊㅍㅎ ㅠㅜㅡ',
                'ㅊㅠㅍㅜㅋㅡㅎㅣ', 'ㅌㅓㅍㅜㅋㅏㅊㅣ', 'ㅍㅜㄹㅡㄴㅎㅏㄴㅡㄹ',
                'ㅃㅉㄸㄲㅆ', 'ㅒㅖ', 'ㅃㅉㄸㄲㅆ ㅒㅖ',
                'ㄲㅒㄸㅖㅃㅏㅉㅓ', 'ㅆㅣㄲㅣㄸㅏㅃㅒ', 'ㄸㅓㄴㅏㄱㅣ',
                'ㅁㅂㅋㅃ ㄴㅈㅌㅉ ㅇㄷㅊㄸ ㄹㄱㅍㄲ',
                'ㅏㅑㅓㅕㅗㅛㅜㅠㅡㅣ',
                'ㄱㅏㄴㅏㄷㅏㄹㅏㅁㅏㅂㅏㅅㅏ',
                'ㅇㅏㅈㅏㅊㅏㅋㅏㅌㅏㅍㅏㅎㅏ'
        ...
        keyboard_word_ko: {
            items: [
                ...
                '뿌리', '따님', '씨앗', '꼬마', '오빠', '찌개', '아저씨', '코끼리', '까마귀',
                // 5단계: 실전 받침 단어
                '대한민국', '컴퓨터', '인터넷', '키보드', '마우스', '프로그램', '데이터', '네트워크', '알고리즘'
            ]
        },
    ...
    // 필수 데이터는 항상 최신으로 덮어씀
    const FORCE_OVERWRITE_KEYS = [
        'keyboard_basic_ko', 'keyboard_basic_en',
        'keyboard_word_ko', 'keyboard_word_en',
        'words_ko', 'words_en'
    ];
